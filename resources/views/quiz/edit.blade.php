            ...
            <div class="page-title-actions px-3 d-flex">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('quiz.index', $quiz->id) }}">Quiz</a>
                        </li>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" value="{{ $quiz->title }}" required
                                                class="form-control" id="titleInput" placeholder="Enter quiz title">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" min="1" name="duration_per_question"
                                                ...
                                                id="durationInput" placeholder="Enter duration per question">
                                        </div>
                                    </div>
