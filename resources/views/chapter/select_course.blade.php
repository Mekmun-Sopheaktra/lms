...
@section('title', $app_setting['name'] . ' | Select Chapter Course')

@section('content')
    <!-- ****Body-Section***** -->
    <div class="app-main-outer">
        <div class="app-main-inner">
            <h3 class="mb-4 px-3">Select a course to view chapters</h3>
            <div class="row">
                                        ...
                                        <p class="card-text mb-3"><span class="pe-3"> <strong>Category:</strong>
                                            ...
                                            <span class="pe-3"><strong>Price:</strong>
                                                @if ($app_setting['currency_position'] == 'Left')
                                                    {{ $app_setting['currency_symbol'] }}{{ $course->price && $course->regular_price ? $course->price : $course->regular_price }}
                                                @else
                                                    {{ $course->price && $course->regular_price ? $course->price : $course->regular_price }}{{ $app_setting['currency_symbol'] }}
                                                @endif
                                            </span>
                                        </p>
