                ...
                <div class="col-6 px-5 py-4">
                    ...
                    <div class="d-flex h-100">
                        <div class="my-auto w-100">
                            <h3 class="fw-bold mb-3">Enter Code</h3>
                            <span class="text-muted">We sent an OTP code to your email address - <strong>{{ email
                                    }}</strong></span>
                            ...
                            <form @submit.prevent="verifyOtp" class="my-4">
                                ...
                                <span v-if="resendTimeLeft !== '00'" class="d-block mb-3">Resend OTP in <span
                                        class="text-primary">00:{{ resendTimeLeft
                                        }}</span></span>
                                <a v-else @click="resendOtp" class="text-primary d-block">Resend OTP</a>
                                <button type="submit" class="btn btn-primary w-100 rounded-pill mt-3">Confirm
                                    OTP</button>
                            </form>
                        </div>
                    </div>
...
setInterval(() => {
    if (resendTimeLeft.value > 0) {
        ...
        resendTimeLeft.value < 10 ? resendTimeLeft.value = '0' + resendTimeLeft.value : resendTimeLeft.value;
    }
}, 1000);
