                ...
                <div class="col-6 px-5 py-4">
                    ...
                    <div class="d-flex h-100">
                        <div class="my-auto w-100">
                            <h3 class="fw-bold mb-3">Recover Password</h3>
                            <span class="text-muted">We will send you a OTP code to recover your password</span>
                            ...
                            <form class="my-4" @submit.prevent="sendOtp">
                                ...
                                <button type="submit" class="btn btn-primary w-100 rounded-pill mt-3">Proceed
                                    Next</button>
                            </form>
