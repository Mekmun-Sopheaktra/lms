<template>
    <section class="play-meta-background">
        <span class="container d-block text-light"
            >Home/<router-link
            ...
            <div class="card-body">
                <section v-if="canView" class="row">
                    <section class="col-7 px-4">
                        ...
                        <iframe
                            ...
                            width="100%"
                            height="400"
                            :src="contentData.media_link"
                            title="Discover New PHP Attributes, Number Defaults, and Taylor&#39;s New Composer Script 🧙"
                            frameborder="0"
                        ...
                        ></iframe>
                        <div
                            v-if="contentData.type == 'audio'"
                            class="border border-primary text-center px-4 pb-4 pt-5 rounded mb-5"
                        >
                            <i
                                class="bi bi-mic display-1 rounded-circle border px-3 text-primary"
                            ></i>
                        ...
                        <div
                            v-if="contentData.type == 'document'"
                            class="text-center border border-primary rounded py-5 mb-5"
                        >
                            <i
                                class="bi bi-file-earmark-text display-1 rounded-circle border px-3 text-primary"
                            ></i>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p
                                    class="instructor-title text-uppercase text-muted"
                                >
                                    Instructor
                                </p>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    >
                                        ...
                                        <p
                                            class="instructor-details text-muted"
                                        >
                                            {{
                                                courseData?.course?.instructor
                                                    ?.title
                    ...
                    <section class="col-5 border-start px-4">
                        <h3 class="mb-5 fw-bold fs-2">Playlist</h3>
                        <CourseLessons
                ...
                <section v-else>
                    <div class="text-center text-muted">
                        ...
                        <p class="mb-0 mt-3">Content not available</p>
                    </div>
                </section>
            </div>
        </div>
