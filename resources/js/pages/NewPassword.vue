                ...
                <div class="col-6 px-5 py-4">
                    ...
                    <div class="d-flex h-100">
                        <div class="my-auto w-100">
                            ...
                            <span class="text-muted">Create a new and strong password that you can remember.</span>
                            ...
                            <form @submit.prevent="updateProfile" class="my-4">
                                ...
                                <button type="submit" class="btn btn-primary w-100 rounded-pill mt-3">Save
                                    Password</button>
                            </form>
