<template>
    <section class="py-3 mb-5">
        <span class="d-block mb-5">Home/Profile</span>
        <form @submit.prevent="updateProfile">
            <div class="row flex-column-reverse flex-md-row mb-4">
                ...
                <div class="col-md-6 mb-5 mb-md-0">
                    <div
                        class="theme-shadow p-5 rounded d-flex h-100 align-items-center"
                    >
                        <div class="w-100">
                            <img
                                :src="
                            ...
                            <label
                                for="upload-pp"
                                class="upload-pp-btn btn btn-outline-primary border-2 w-100"
                            >
                                Upload image
                            </label>
                            <p
