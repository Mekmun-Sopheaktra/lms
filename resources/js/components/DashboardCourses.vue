<template>
    <section class="py-3 mb-5">
        <span class="d-block mb-5">Home/My Courses</span>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            >
                        ...
                        <div class="theme-shadow rounded d-flex p-3">
                            ...
                            <div class="w-100">
                                <router-link
                                    ...
                                    >{{ course.instructor.name }}</router-link
                                >
                                <router-link
                                ...
                                <div class="mb-3">
                                    <small class="me-3">
                                        <i
                                            class="bi bi-clock text-success me-1"
                                        ></i>
                                        {{
                                            formatDuration(
                                    ...
                                    <small class="me-3">
                                        <i
                                            class="bi bi-play-circle text-danger me-1"
                                        ></i>
                ...
                <div v-if="inProgressCourses.length === 0" class="col-12">
                    <div class="text-center text-muted">
                        ...
                        <p class="mb-0 mt-3">No Course Available in Progress</p>
                    </div>
                </div>
            </div>
            <div
            ...
            >
                ...
                <div v-if="completedCourses.length === 0" class="col-12">
                    <div class="text-center text-muted">
                        <i class="bi bi-emoji-frown display-5"></i>
                        <p class="mb-0 mt-3">No Course Completed</p>
                    </div>
                </div>
            </div>
        </div>
